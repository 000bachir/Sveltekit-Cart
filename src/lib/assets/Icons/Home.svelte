<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24"
	><defs><path id="SVG1WEi9bFG" d="M10.75 9.5a1.25 1.25 0 1 1 2.5 0a1.25 1.25 0 0 1-2.5 0" /></defs
	><path
		fill="#fff"
		fill-rule="evenodd"
		...
		clip-rule="evenodd"
	/><g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" opacity="0.8"
		><use href="#SVG1WEi9bFG" /><use href="#SVG1WEi9bFG" /></g
	><path
		fill="currentColor"
